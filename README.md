...
| Farhan Ishraq Ifti | `252-35-648-ops` | Documentation and evidence — wrote `EVENT.md`, `README.md`, `LICENSES.md`, and `evaluation-manifest.json` |`README.md`, `LICENSES.md`, and `evaluation-manifest.json` |
